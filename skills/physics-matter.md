...
**Related skills files:** game-setup-and-config.md, sprites-and-images.md, physics-arcade.md, tilemaps.md

## Quick Start

```js
// 1. Enable Matter physics in game config
const config = {
    type: Phaser.AUTO,
    width: 800,
    height: 600,
...
// 2. Create physics-enabled objects in create()
function create () {
...
function update () {
    ...
    if (cursors.up.isDown && this.player.body.velocity.y > -0.1) {
