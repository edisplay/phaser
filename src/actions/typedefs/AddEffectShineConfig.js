 ...
 * @property {Phaser.Display.ColorBand | Phaser.Types.Display.ColorBandConfig | (Phaser.Display.ColorBand | Phaser.Types.Display.ColorBandConfig)[]} [bands] - Custom color bands to use in the gradient. If this is defined, `shineColor` does nothing.
