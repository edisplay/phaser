 ...
 * @property {Phaser.Filters.Blend} blendFilter - The Blend filter which makes the image shine by multiplying it by the gradient. This controls the brightness of the shine. In `reveal` move, this belongs to the target and will be removed when the target is destroyed. You can remove if yourself to remove the shine effect. When not in `reveal` move, this belongs to `parallelFilters.top`.
 */
